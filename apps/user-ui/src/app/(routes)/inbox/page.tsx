...
const ChatPage = () => {
  ...
  const handleSend = (e: any, attachments: string[] = []) => {
                  ...
                  return (
                    ...
                    >
                      <div className="flex items-center gap-3">
                        <Image
                          src={
                            (typeof chat.seller?.avatar === 'object' && chat.seller.avatar?.url) ||
                            (typeof chat.seller?.avatar === 'string' && chat.seller.avatar.trim()) ||
            ...
            {selectedChat ? (
              <>
                <div className="p-4 border-b border-b-gray-200 bg-white flex items-center gap-3">
                  <Image
                    src={
                      (typeof selectedChat.seller?.avatar === 'object' && selectedChat.seller.avatar?.url) ||
                      (typeof selectedChat.seller?.avatar === 'string' && selectedChat.seller.avatar.trim()) ||
                      'https://ik.imagekit.io/shahriarbecodemy/avatar/6_t8b5y8t3U.png'
                    }
