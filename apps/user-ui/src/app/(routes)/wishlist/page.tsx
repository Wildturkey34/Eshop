    ...
    <div className="w-full bg-white">
      <div className="md:w-[80%] w-[95%] mx-auto min-h-screen">
        ...
        <div className="pb-[50px]">
          ...
          <span className="inline-block p-[1.5px] mx-1 bg-[#a8aacbo] rounded-full">
            .
          </span>
              ...
              <tbody>
                {wishlist?.map((item: any) => (
                  <tr key={item.id} className="border-b border-b-[#0000000e]">
                    ...
                    <td>
                      <button
                        className="text-[#818487] cursor-pointer hover:text-[#ff1826] transition duration-200 items-center"
