...
const ProductDetailsCard = ({
  ...
  const removeFromWishlist = useStore((state: any) => state.removeFromWishlist); // Changed: removeFromWishList -> removeFromWishlist
  ...
  return (
    ...
    >
      <div
        className="w-[90%] md:w-[70%] md:mt-14 2xl:mt-0 h-max overflow-scroll min-h-[70vh] md:p-6 shadow-md bg-white rounded-lg"
          ...
          <div className="w-full md:w-1/2 md:pl-8 mt-6 md:mt-0">
            ...
            <div className="border-b relative pb-3 border-gray-200 flex items-center justify-between">
              <div className="flex items-start gap-3">
                ...
                <Image
                  src={
                    (typeof data?.Shop?.avatar === 'string' && data.Shop.avatar.trim()) ||
              ...
              <button
                className="flex items-center justify-center gap-2 px-4 py-2 bg-blue-600 hover:bg-blue-700 text-white rounded-lg transition-all duration-200 font-medium transform hover:scale-105"
                onClick={() => handleChat()}
              >
                💬 Chat with seller
              </button>{' '}
                ...
                <div>
                  ...
                  <div className="flex gap-2 mt-1">
                    {data.sizes.map((size: string, index: number) => (
                      <button
                        key={index}
                        className={`px-3 py-1.5 cursor-pointer rounded-md transition text-sm font-medium ${
                          isSizeSelected === size
            ...
            <div className="mt-5 flex items-center gap-5">
              ...
              <button className="opacity-[.7] cursor-pointer">
                <Heart
                  ...
                  color={isWishlisted ? 'transparen' : 'black'}
                  onClick={() =>
                    isWishlisted
