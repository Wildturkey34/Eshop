...
const page = () => {
  ...
  return (
    <div className="w-full min-h-screen p-8">
      ...
      {showModal && (
        <div className="fixed top-0 left-0 size-full bg-black bg-opacity-50 flex items-center justify-center">
              ...
              <div className="mt-2">
                ...
                <Controller
                  ...
                  render={({ field }) => (
                    <select
                      {...field}
                      className="w-full border outline-none border-gray-700 bg-transparent p-3 items-center text-white rounded-md"
                    >
