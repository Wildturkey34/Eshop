...
const Page = () => {
  ...
  const onSubmit = async (data: any) => {
    try {
      ...
      // Filter out null/undefined images and empty objects before submitting
      const validImages = (data.images || []).filter((img: any) => {
        return img !== null && img !== undefined && (img?.url || img?.file_url);
      });
      ...
      const response = await axiosInstance.post('/product/api/create-product', eventData, isProtected);
        ...
        <div className="md:w-[65%]">
          <div className="w-full flex gap-6">
            ...
            <div className="w-2/4">
              <Input
                label="Event Title *"
                placeholder="Enter event title (e.g., Black Friday Sale, Summer Clearance)"
              ...
              <div className="mt-2">
                <Input
                  ...
                  placeholder="Enter event description for quick preview"
              ...
              <div className="mt-2">
                <Input
                  label="Tags *"
                  placeholder="sale,discount,limited-time,flash-sale"
                  {...register('tags', {
                    required: 'Separate event tags with a comma',
                  })}
                />
                {errors.tags && (
                  <p className="text-red-500 text-xs mt-1">
                  ...
                  rules={{
                    ...
                    validate: (value) => {
                      ...
                      console.log('Description validation:', {
                        originalLength: textValue.length,
                      ...
                      return (
                        wordCount >= 20 ||
                        `Description must be at least 20 words! (Current: ${wordCount} words)`
                      );
                    },
                  }}
                  render={({ field }) => (
